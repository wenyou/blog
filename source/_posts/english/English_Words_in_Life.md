...
* mop  /mɑːp/  n.拖把；蓬乱浓密的头发；清扫；洗碗刷；雇工市场；鬼脸  v.用拖把拖；擦掉，抹掉；结束，完成；扮鬼脸
* dust  /dʌst/  n.沙尘；灰尘；粉末；尘雾；除尘，掸灰； v.擦去……的灰尘；把粉末撒于；
* stove  /stoʊv/  n.（取暖或烹饪用的）炉子，火炉；厨灶，炉头；窑；
* sweep  /swiːp/  v.打扫，清除；（迅猛地）带走，卷走； n.打扫，清扫；挥动；巡行，扫荡；
...
* troll  /troʊl/  n.巨怪，侏儒怪物；恶意挑衅的帖子，发挑衅帖子的人；  v.拖捞，拖钓；搜寻，寻找；随便浏览，随便翻翻；  Ex: It is too easy to troll smug libs 招惹、戏耍那些自负的自由派简直太容易了.
* smug  /smʌɡ/  n.书呆子；自命不凡的家伙 adj.自鸣得意的；自以为是的；整洁的
...
![Traits](/images/positive_negative_traits.jpg "Positive vs Negative Personality Traits")



---
* 常见prep.简词at、in、on、up、with、for、by、away、to、from、of、off 用法
![prep.](/images/prep-at_in_on_up_with_for_by_away_to_from_of_off.jpg "prep.")